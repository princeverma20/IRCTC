...
public class Ticket {
    ...
    public Ticket(long trainId, String trainName, String time, String st1, String st2, String cla, String firstName, String lastName, Integer age, String pnr, String path, String stTime, String endTime, Integer coachNum, Integer seatNum, float fair, String user, String bookedAt, Boolean cnf, Integer WL) {
